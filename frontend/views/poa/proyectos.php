...
//die();
$modelPoa = Poa::findOne(['id' => $id]);
$estado_poa = true;
if (isset($modelPoa)) {
    $estado_poa = $modelPoa->estado == 1 ? false : true;
}
                ...
                [
                    ...
                    'value' => function($data) {
                        ...
                        [
                            ...
                            'label' => 'Año Final',
                            'value' => function ($data) {
                        return substr($data['fecha_fin'], 0, strpos($data['fecha_fin'], "-", 1));
                    }
                        ],
                        [
                            ...
                            'urlCreator' => function($action, $model, $key, $index) {
                                return Url::to(['/' . $action, 'id' => $key,]);
                                    ...
                                    'toolbar' => [
                                        ['content' =>
                                            $boton_aprobar .
                                            Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['', 'id' => $_GET['id'], 'accion' => $accion], ['data-pjax' => 1, 'class' => 'btn btn-default', 'title' => 'Reset Grid']) .
                                            //'{toggleData}' .
                                            '{export}'
                                        ],
                                    ],
