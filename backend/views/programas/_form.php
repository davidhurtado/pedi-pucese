...
<div class="programas-form">
    ...
    if ($controlador == 'estrategias') {
        ...
        <div class="form-group field-programas-presupuesto col-md-6 col-xs-12 col-sm-6 required">
            <?= $form->field($model, 'presupuesto')->textInput() ?>
        </div>
        <div class="form-group field-programas-validacion col-md-6 col-xs-12 col-sm-6 required">
