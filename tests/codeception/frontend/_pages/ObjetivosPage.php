 ...
 */
class ObjetivosPage extends BasePage {

    public $route = 'objetivos/index';

    /**
     * @param array $objetivosData
     */
    ...
    public function insert(array $objetivosData) {
        $this->actor->fillField('textarea[name="Objetivos[descripcion]"]', $objetivosData[0]);
        ...
        $this->actor->fillField('input[name="Objetivos[fecha_fin]"]', $objetivosData[2]);
