...
class Proyectos extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['nombre', 'descripcion', 'colaboradores','estado', 'fecha_inicio', 'fecha_fin', 'numeracion'], 'required'],
            [['numeracion', 'estado','validacion'], 'integer'],
            [['numeracion'], 'VerifNum'],
            [['estado'], 'VerifCheck'],
            [['id_programa'], 'integer'],
    ...
    public function saveProyecto() {
        ...
        $proyecto->estado = $this->estado;
        $proyecto->validacion = $this->validacion;
